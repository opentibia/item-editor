...
protected:
	...
	enum controlEdit_t{
		IDC_EDITCID_FLAG = 1,
		IDC_EDIT_SPEED_FLAG = 2,
		IDC_EDIT_LIGHT_LEVEL_FLAG = 4,
		IDC_EDIT_LIGHT_COLOR_FLAG = 8,
		IDC_EDIT_TOPORDER_FLAG = 16,
		IDC_EDIT_MINIMAP_COLOR_FLAG = 32,
	};
	...
	enum controlOpt_t{
		...
		IDC_OPT_CANNOTDECAY_FLAG = 2048,
		IDC_OPT_DISTREAD_FLAG = 4096,
		IDC_OPT_HANGABLE_FLAG = 8192,
		IDC_OPT_VERTICAL_FLAG = 16384,
		IDC_OPT_HORIZONTAL_FLAG = 32768,
		IDC_OPT_CHARGES_FLAG = 65536,
		IDC_OPT_LOOKTHROUGH_FLAG = 131072
	};

	enum controlCombo_t{
		IDC_COMBO_FLOOR_FLAG = 1,
	};
