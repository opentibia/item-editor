...
#ifndef __OTITEMEDITOR_FILELOADER_H__
...
class WritePropStream{
public:
	WritePropStream(){buffer = (char*)malloc(32*sizeof(char)); buffer_size = 32; size = 0;}
	~WritePropStream(){free(buffer);};
